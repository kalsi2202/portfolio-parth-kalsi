...
const styles = {
    ...
    anal: " dark ml-28 w-8/12 dark:bg-slate-800 dark:text-slate-500 ",
...
export const layout = {
    ...
    menu: `dark ${styles.flexBetween} flex-col float-left bottom-0 left-0 fixed w-1/9 text-slate-400 dark:bg-slate-800 dark:text-slate-500`,
